...
namespace StageBear.Migrations
{
    ...
    [Migration("20251113210335_FixedModelLabelsAndDatePurchased")]
    partial class FixedModelLabelsAndDatePurchased
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StageBear.Models.Purchase", b =>
                {
                    ...
                    b.Property<string>("ClientStAddress")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("DatePurchaed")
            ...
            modelBuilder.Entity("StageBear.Models.Purchase", b =>
                {
                    b.HasOne("StageBear.Models.Show", "Show")
                        .WithMany("Purchases")
